...
message.channel.send(new Discord.MessageEmbed().setColor('9c5cb2').setThumbnail('https://media.discordapp.net/attachments/759022175444926514/773963799978967080/350kb_1.gif').setTitle('İşte bu kadar!').setDescription(`${message.author} Yavaş mod için (\`${args[0]}\`) saniye olarak uygulandı!`)).then(a => a.delete({timeout: 10000}));
};
exports.conf = {
  enabled: true,
  guildOnly: true,
